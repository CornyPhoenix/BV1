...
\begin{document}
	...
	\begin{longtable}{@{}p{\dimexpr\textwidth-8.5cm}@{}p{4cm}@{\hspace{.5cm}}p{4cm}@{}}
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{lena}} \linebreak \textit{Original Image}&\\
%		
		a) \textbf{Robert's Cross operator} \par
		Looks very noisy
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{roberts_cross_magnitudes}} \linebreak \textit{Magnitudes}
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{roberts_cross_directions}} \linebreak[1cm] \textit{Directions}\\
%		
		b) \textbf{Sobel operator} \par
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{sobel_magnitudes}} \linebreak \textit{Magnitudes}
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{sobel_directions}} \linebreak \textit{Directions}\\
%		
...
%		
		...
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{laplace_d2}} \linebreak \textit{2\raisebox{2pt}{\footnotesize nd} Derivative}
		&\\
		
		Extra: \textbf{Scharr operator}  \par
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{scharr_magnitudes}} \linebreak \textit{Magnitudes}
		& \raisebox{-\totalheight}{\includegraphics[width=\linewidth]{scharr_directions}} \linebreak \textit{Directions}\\
	\end{longtable}
